            ...
            <div>
              ...
              <div className="flex items-center lg:order-2 relative ">
                ...
                {isDropDownMenuOpen && (
                  ...
                  >
                    <ul
                      className="py-2 text-sm text-subHeader dark:text-gray-200"
              ...
              >
                <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                  <NavLink
                    to={"/"}
                    className="block py-2 pr-4 pl-3 font-light border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"
                  >
                    Home
                  </NavLink>
                  <NavLink
