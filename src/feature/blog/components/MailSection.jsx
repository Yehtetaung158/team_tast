    ...
    <section className=" flex flex-col items-center justify-center my-10">
      <div className=" flex items-center justify-around gap-12 w-full py-6">
        <div className=" flex flex-col ">
          <h1 className=" text-[40px] font-semibold">5M+</h1>
          <p className=" text-fontSizeLable text-grayShades.30">Customer</p>
        </div>
        <div className=" flex flex-col ">
          <h1 className=" text-[40px] font-semibold">280M</h1>
          <p className=" text-fontSizeLable text-grayShades.30">Coverage</p>
        </div>
        <div className=" flex flex-col ">
          <h1 className=" text-[40px] font-semibold">22%</h1>
          <p className=" text-fontSizeLable text-grayShades.30">Earnings</p>
        </div>
      </div>
      <div className="flex flex-col sm:flex-row items-center justify-between w-full border-2 px-6 py-12 rounded-lg">
        ...
        <div className="w-full sm:w-1/2 flex items-center justify-center gap-3">
          <input
